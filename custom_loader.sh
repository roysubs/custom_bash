...
exx "git clone https://roysubs:GHP_TOKEN_GOES_HERE@github.com/roysubs/custom_bash --depth=1"
exx "Then can git push up to repository:"
exx "gpush   =>   git add .  ;  git commit -m 'test'  ;  git status  ;   git push -u origin master"
